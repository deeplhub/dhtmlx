...
scheduler.form_blocks = {
    ...
    warnDate: {
        ...
        set_value: function(e, t, i, s) {
        	//源码
        	//e.firstChild.value = t || ""
        	var oldT = (new Date(t)).getTime(); //得到毫秒数
//        	debugger;
        	if(t != "" && t != null){
        		var oldTime = (new Date(i.end_date)).getTime(); //得到毫秒数
            	
            	var day = parseInt((oldTime-oldT)/1000/60/60/24);//算出天数
            	var hour = parseInt((oldTime-oldT)/1000/60/60-(24*day));//算出小时数
            	var minute = parseInt((oldTime-oldT)/1000/60-(hour+24*day)*60);//算出分钟数
